...
public class PersistentPlayer : MonoBehaviour
{
    ...
    public void resetDeck()
    {
        ...
        myDeck.Add(new Card(16, "Sabotage!", 2, 0, "Lower Enemy Energy by 2", 80));
        myDeck.Add(new Card(17, "Outshine", 3, 0, "lower enemy affection by 20", 80));
        myDeck.Add(new Card(18, "Enthrall", 4, 0, "Distract and Prime the audience", 80));
